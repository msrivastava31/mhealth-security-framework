 ...
 * It contains methods that convert a SecureLong object to encrypted bytes and vice versa
...
public class SecureLongConverter extends AbstractSecureConverter {
    /**
     * Encrypts the sensitive Long object prior to storing it in database storage.
     * @param value the Secure Long object
    ...
    /**
     * Retrieves the sensitive Long object after decrypting it.
     * @param encryptedValue byte array of the encrypted object
     * @return the Secure Long object
     */
    @TypeConverter
